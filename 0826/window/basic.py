...
from db.login_register import Basic_Login, Basic_Register

from ui.ui_loginForm import loginForm
from ui.ui_registerForm import registerForm

from window.mainhome import mainhomepage
